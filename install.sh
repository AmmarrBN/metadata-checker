...
install_exiftool_from_source() {
    ...
    cd /tmp
    wget https://sourceforge.net/projects/exiftool/files/Image-ExifTool-13.39.tar.gz/download -O Image-ExifTool-13.39.tar.gz
    tar -xzf Image-ExifTool-13.39.tar.gz
